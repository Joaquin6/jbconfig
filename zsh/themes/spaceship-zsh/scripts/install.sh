#!/usr/bin/env zsh
#
# Author: Joaquin Briceno, https://github.com/Joaquin6
# https://github.com/Joaquin6/spaceship-zsh
...
ZSHRC="$HOME/.zshrc"
REPO='https://github.com/Joaquin6/spaceship-zsh.git'
SOURCE="$PWD/spaceship.zsh"
USER_SOURCE="$HOME/.spaceship-zsh"
...
if [[ ! -f "$SOURCE" ]]; then
  ...
  # Clone repo into the ~/..spaceship-zsh and change SOURCE
